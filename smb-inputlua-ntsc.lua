...
function drawStats(x, y)
	...
	drawText(x, y + 28, letterTable("speed"))
	drawText(x, y + 35, letterTable("x " .. memory.readbytesigned(87) .. "." .. memory.readbyte(1797)))
	drawText(x, y + 42, letterTable("y " .. memory.readbytesigned(159) .. "." .. memory.readbyte(1075)))
	drawText(x, y + 56, letterTable("fr " .. math.fmod(math.floor((emu.framecount() - emu.lagcount() - 1) / 21), 32767)))
	drawText(x, y + 63, letterTable("f " .. memory.readbyte(9)))
	drawText(x, y + 70, letterTable("r " .. remainder))
	drawText(x, y + 77, letterTable("-" .. frame))
	drawText(x, y + 91, letterTable("sock"))
	drawText(x, y + 98, letterTable(sock()))
	drawText(x, y + 112, letterTable("fcount"))
	drawText(x, y + 119, letterTable(tostring(emu.framecount())))
	drawText(x, y + 133, letterTable("time"))
	drawText(x, y + 140, letterTable("h " .. timeCount()[1]))
	drawText(x, y + 147, letterTable("m " .. timeCount()[2]))
	drawText(x, y + 154, letterTable("s " .. timeCount()[3]))
	drawText(x, y + 168, letterTable("lag " .. emu.lagcount()))
	if (memory.readbyte(22) == 45 or memory.readbyte(23) == 45 or memory.readbyte(24) == 45 or memory.readbyte(25) == 45 or memory.readbyte(26) == 45) then
		drawText(x, y + 182, letterTable("bowser " .. memory.readbyte(1155)))
	end
end
